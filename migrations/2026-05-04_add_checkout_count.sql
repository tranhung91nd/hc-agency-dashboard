-- ═══════════════════════════════════════════════════════════════
-- Migration: thêm cột checkout_count cho campaign_daily_mess
--
-- Lưu "Lượt bắt đầu thanh toán" (initiate_checkout) từ Meta Insights.
-- Action types được parse: initiate_checkout, onsite_conversion.initiate_checkout,
...
-- Cập nhật RPC public report để trả về checkout_count
